 ...
 * Produz um número aleatório de itens e os insere no buffer.
 * @param args Um ponteiro para produtor_args contendo o ID e a quantidade a produzir.
 */
 ...
 * Espera o buffer encher, consome os 5 itens, calcula a média e imprime.
 * Repete até que todas as produtoras tenham finalizado.
 */
